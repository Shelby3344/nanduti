...
const LINHAS = [
  {
    ...
    nome: 'Canetas',
    itens: [
      { n: 'Glow',          p: 455, fotos: ['assets/img/produtos/caneta-glow-alluvi.webp',
      ...
      { n: 'Glow Alpen',    p: 677, img: 'assets/img/produtos/caneta-glow-alpen.webp' },
      { n: 'Retra Verde',   p: 455, img: 'assets/img/produtos/caneta-retra-verde.webp' },
      { n: 'NAD + B12',     p: 425, img: 'assets/img/produtos/caneta-nad-b12.webp' },
      { n: 'Retra Alluvi',  p: 853, img: 'assets/img/produtos/caneta-retra-alluvi.webp' },
      { n: 'Tirzepatida',   p: 611, img: 'assets/img/produtos/caneta-tirzepatida.webp' },
      { n: 'Klow 80mg',     d: 'caneta', p: 680, img: 'assets/img/produtos/caneta-klow80.webp' },
      { n: 'Retra 40mg',    d: 'sem agulha', p: 635, img: 'assets/img/produtos/caneta-retra-alluvi.webp' },
      { n: 'Retra 40mg',    d: 'com agulha', p: 635, img: 'assets/img/produtos/caneta-retra-alluvi.webp' },
      { n: 'Tirzegen',      d: 'sem agulha', p: 635, img: 'assets/img/produtos/oxygen-tirzegen-pen.webp' },
      // Foto: caneta NAD+ 1000mg+B12 da fonte oficial (único NAD+ Pen do catálogo Oxygen); item sem dose na tabela.
      { n: 'NAD+ Pen',      p: 660, img: 'assets/img/produtos/caneta-nadpen.webp' },
      ...
      { n: 'Mounjaro',      p: 1230, img: 'assets/img/produtos/mounjaro-kwikpen.webp' },
    ],
  },
  {
    id: 'renew',
    nome: 'Peptídeos',
    itens: [
      { n: 'GHK-CU 50mg',    p: 220, img: 'assets/img/produtos/px-ghk-cu-50.webp' },
      { n: 'GHK-CU 100mg',   p: 250, fotos: ['assets/img/produtos/neo-ghk-cu-100.webp',
                                             'assets/img/produtos/neo-ghk-cu-100-b.webp'] },
      { n: 'Ipamorelin 10mg',p: 260, img: 'assets/img/produtos/px-ipamorelin.webp' },
      { n: 'BPC-157 10mg',   p: 260, img: 'assets/img/produtos/renew-bpc157.webp' },
      { n: 'TB-500 10mg',    p: 260, img: 'assets/img/produtos/renew-tb500.webp' },
      { n: 'Glutathione',    p: 260 },
      { n: 'Frag 176 10mg',  p: 501, img: 'assets/img/produtos/neo-frag176.webp' },
      { n: 'Frag 176 15mg',  p: 300, img: 'assets/img/produtos/neo-frag176.webp' },
      { n: 'PT-141',         p: 285, img: 'assets/img/produtos/px-pt141.webp' },
      { n: 'Glow 70mg',      p: 280, img: 'assets/img/produtos/neo-glow-70.webp' },
      { n: 'Klow 80mg',      p: 285, img: 'assets/img/produtos/renew-klow-80.webp' },
      { n: 'MOTS 10mg',      p: 285, img: 'assets/img/produtos/renew-mots.webp' },
      { n: 'DSIP',           p: 285, img: 'assets/img/produtos/renew-dsip.webp' },
      { n: 'CJC + IPA',      p: 285, img: 'assets/img/produtos/neo-cjc-ipa.webp' },
      { n: 'Epithalon',      p: 285, img: 'assets/img/produtos/renew-epithalon.webp' },
      { n: 'SS31',           p: 285, img: 'assets/img/produtos/renew-ss31.webp' },
      { n: 'AOD9604',        p: 300, img: 'assets/img/produtos/px-aod9604.webp' },
      { n: 'BB10',           p: 285 },
      { n: 'Selank',         p: 285, img: 'assets/img/produtos/renew-selank.webp' },
      { n: 'Semax',          p: 285, img: 'assets/img/produtos/renew-semax.webp' },
      { n: 'NAD+ 100',       p: 230 },
      { n: 'NAD+ 500',       p: 280, img: 'assets/img/produtos/px-nad500.webp' },
      { n: 'SLUP332',        p: 300, img: 'assets/img/produtos/neo-slupp332.webp' },
      { n: 'Kisspeptin',     p: 300, img: 'assets/img/produtos/renew-kisspeptin.webp' },
      { n: 'KPV',            p: 285, img: 'assets/img/produtos/px-kpv.webp' },
      { n: 'Wolverine',      p: 285, img: 'assets/img/produtos/neo-wolverine.webp' },
      { n: 'CBL 20mg',       p: 300, img: 'assets/img/produtos/px-cbl20.webp' },
      { n: 'Tesamorelin',    p: 295, img: 'assets/img/produtos/neo-tesamorelin.webp' },
      { n: 'Retatrutide',    p: 300, img: 'assets/img/produtos/renew-retatrutide.webp' },
      { n: 'MOTS 40mg',      p: 330, img: 'assets/img/produtos/renew-mots.webp' },
      { n: 'CBL 60mg',       p: 360 },
      { n: 'Tirzec 30mg',     p: 260 },
      { n: 'Tirzec 60mg',     p: 300 },
      { n: 'Oxytocin 10mg',   p: 285 },
      { n: 'Pinealon 10mg',   p: 285 },
      { n: 'Tesa + Ipa 20mg', p: 330 },
      { n: 'Tesa 20mg',       p: 330 },
    ],
  },
  {
    ...
    itens: [
      { n: 'TG 15mg',                 p: 520, img: 'assets/img/produtos/tg-15mg.webp' },
      { n: 'Lipo Biotidina',          p: 230, img: 'assets/img/produtos/lipo-biotidina.webp' },
      { n: 'Lipoless MD',             p: 480, img: 'assets/img/produtos/lipoless-md.webp' },
      { n: 'Lipoless',                d: '4 ampolas', p: 485, img: 'assets/img/produtos/lipoless-md.webp' },
      { n: 'Lipoless Orgoglip 0.8',   p: 255, img: 'assets/img/produtos/lipoless-orgoglip.webp' },
      { n: 'Lipoless Orgoglip 2.5',   p: 280, img: 'assets/img/produtos/lipoless-orgoglip.webp' },
      { n: 'Lipoless Orgoglip 5.5',   p: 300, img: 'assets/img/produtos/lipoless-orgoglip.webp' },
      { n: 'Lipoland MD',             p: 430, img: 'assets/img/produtos/lipoland-md.webp' },
      { n: 'Lipoland',                d: '4 ampolas', p: 480, img: 'assets/img/produtos/lipoland.webp' },
      { n: 'Tirzec',                  d: '1 ampola',  p: 475, img: 'assets/img/produtos/tirzec-md.webp' },
      { n: 'Tirzec',                  d: '4 ampolas', p: 480, img: 'assets/img/produtos/tirzec.webp' },
      { n: 'Tirzedal',                d: '4 ampolas', p: 480, img: 'assets/img/produtos/tirzedal.webp' },
      { n: 'Tirzedral T36',           p: 530, img: 'assets/img/produtos/tirzedral-t36.webp' },
      { n: 'Tirzedral T36',           d: '4 ampolas', p: 530, img: 'assets/img/produtos/tirzedral-t36.webp' },
      { n: 'Gluconex',                p: 500, img: 'assets/img/produtos/gluconex.webp' },
      { n: 'Slimex MD',               p: 480, img: 'assets/img/produtos/slimex-md.webp' },
      { n: 'Slimex',                  d: '4 ampolas', p: 495, img: 'assets/img/produtos/slimex.webp' },
      { n: 'Lispax',                  p: 451, img: 'assets/img/produtos/lispax.webp' },
    ],
  },
  {
    id: 'po',
    ...
    itens: [
      { n: 'Line Body',                       p: 740, img: 'assets/img/produtos/line-body.webp' },
      { n: 'Botox Dysport',                   p: 265, img: 'assets/img/produtos/dysport.webp' },
      { n: 'Botox Hutos',                     p: 611, img: 'assets/img/produtos/hutox.webp' },
      { n: 'Retra Pó',                        p: 556, img: 'assets/img/produtos/retra-po.webp' },
      { n: 'Retra Syned Diluída 90mg',        p: 798, img: 'assets/img/produtos/retra-syned-90.webp' },
      { n: 'Retra Synedica Pó 120mg',         p: 655, img: 'assets/img/produtos/retra-synedica-120.webp' },
      { n: 'Tirzepatide Synedica Pó 240mg',   p: 600, img: 'assets/img/produtos/tirzepatide-synedica-240.webp' },
      { n: 'Tirzepatide Thera',               p: 721, img: 'assets/img/produtos/tirzepatide-thera.webp' },
      { n: 'Masteron Elite',                  p: 517, img: 'assets/img/produtos/masteron-elite.webp' },
    ],
  },
  {
    id: 'oxygen',
    nome: 'Oxygen',
    itens: [
      { n: 'AHK-CU',         p: 350,  img: 'assets/img/produtos/oxygen-ahk-cu.webp' },
      { n: 'GHK-CU 50mg',    p: 295,  img: 'assets/img/produtos/oxygen-ghk-cu-50.webp' },
      { n: 'GHK-CU 100mg',   p: 350,  img: 'assets/img/produtos/oxygen-ghk-cu-100.webp' },
      { n: 'Cagrisema',      p: 450, img: 'assets/img/produtos/oxygen-cagrisema.webp' },
      { n: 'Tesamorelin',    p: 627,  img: 'assets/img/produtos/oxygen-tesamorelin.webp' },
      { n: 'HGH',            d: '5 ampolas', p: 814, img: 'assets/img/produtos/oxygen-hgh.webp' },
      { n: 'Retagen 80mg',   p: 585,  img: 'assets/img/produtos/oxygen-retagen-80.webp' },
      { n: 'Retagen 120mg',  d: 'diluído', p: 705, img: 'assets/img/produtos/oxygen-retagen-120.webp' },
      { n: 'Retagen 120mg',  d: 'liofilizada', p: 705, img: 'assets/img/produtos/oxygen-retagen-120.webp' },
      { n: 'Retagen 160mg',  p: 700, img: 'assets/img/produtos/oxygen-retagen-160.webp' },
      { n: 'Retagen 40mg',   d: 'diluída', p: 555, img: 'assets/img/produtos/oxygen-retagen40-diluida.webp' },
      { n: 'Retagen 40mg',   d: 'liofilizado', p: 530, img: 'assets/img/produtos/oxygen-retagen40-lio.webp' },
      { n: 'Retagen 60mg',   d: 'liofilizada', p: 580, img: 'assets/img/produtos/oxygen-retagen60.webp' },
      { n: 'Selank',         d: 'nasal', p: 360 },
      { n: 'Semax',          d: 'nasal', p: 360 },
      { n: 'Retatrutide Pen',p: 902,  img: 'assets/img/produtos/oxygen-retatrutide-pen.webp' },
      { n: 'Tirzegen Pen',   p: 635,  img: 'assets/img/produtos/oxygen-tirzegen-pen.webp' },
      { n: 'Glow Pen',       p: 560,  img: 'assets/img/produtos/oxygen-glow-pen.webp' },
      { n: 'GHK-CU Pen',     p: 560,  img: 'assets/img/produtos/oxygen-ghk-cu-pen.webp' },
      { n: 'Klow Pen',       p: 580,  img: 'assets/img/produtos/oxygen-klow-pen.webp' },
    ],
  },
  {
    id: 'esteticos',
    ...
    itens: [
      { n: 'Veltrane 90mg',   p: 500, img: 'assets/img/produtos/veltrane-90.webp' },
      { n: 'Veltrane 120mg',  p: 540, img: 'assets/img/produtos/veltrane-120.webp' },
      { n: 'Veltrane Pure',   p: 677, img: 'assets/img/produtos/veltrane-pure.webp' },
      { n: 'Scuptra',         p: 1111, img: 'assets/img/produtos/sculptra.webp' },
      { n: 'Todo Cann CBO',   p: 721, img: 'assets/img/produtos/todocann-cbo.webp' },
    ],
  },
  {
    id: 'seruns',
    nome: 'Séruns',
    itens: [
      { n: 'Glow Alluvi',  p: 265, img: 'assets/img/produtos/serum-glow-alluvi.webp' },
      { n: 'GHK-CU',       p: 210, img: 'assets/img/produtos/serum-ghk-cu.webp' },
      { n: 'VL',           p: 490, img: 'assets/img/produtos/serum-vl.webp' },
      { n: 'Facial',       p: 391, img: 'assets/img/produtos/serum-facial.webp' },
      { n: 'Mousse',       p: 435, img: 'assets/img/produtos/serum-mousse.webp' },
    ],
  },
  {
    id: 'dermo',
    ...
    itens: [
      { n: 'Dr. Althea 147',  p: 235, img: 'assets/img/produtos/dr-althea-147.webp' },
      { n: 'Dr. Althea 345',  p: 235, img: 'assets/img/produtos/dr-althea-345.webp' },
      { n: 'Celimax Vita',    p: 180, img: 'assets/img/produtos/celimax-vita.webp' },
      { n: 'Numbuzin No.9',   p: 230, img: 'assets/img/produtos/numbuzin-no9.webp' },
      { n: 'Skin1004',        p: 407, img: 'assets/img/produtos/skin1004.webp' },
      { n: 'Medicube Pink',   p: 418, img: 'assets/img/produtos/medicube-pink.webp' },
      { n: 'Medicube Zero',   p: 210, img: 'assets/img/produtos/medicube-zero.webp' },
      { n: 'Quenavin',             d: '30 cápsulas', p: 180, img: 'assets/img/produtos/quenavin-capsulas.jpg' },
      { n: 'Quenavin Shampoo',       p: 175, img: 'assets/img/produtos/quenavin-shampoo.jpg' },
      { n: 'Quenavin Condicionador', p: 175, img: 'assets/img/produtos/quenavin-condicionador.jpg' },
    ],
  },
  {
    id: 'dragon',
    ...
    itens: [
      { n: 'GHK-CU',      p: 280, img: 'assets/img/produtos/dragon-ghk-cu.webp' },
      { n: 'SLU-PP-332',  p: 280, img: 'assets/img/produtos/dragon-slu-pp-332.webp' },
      { n: 'Organ Shield',p: 265, img: 'assets/img/produtos/dragon-organ-shield.webp' },
      { n: 'MK-677',      p: 265, img: 'assets/img/produtos/dragon-mk-677.webp' },
      { n: 'Cardarine',   p: 506, img: 'assets/img/produtos/dragon-cardarine.webp' },
      { n: 'Ligandrol',   p: 265, img: 'assets/img/produtos/dragon-ligandrol.webp' },
    ],
  },
  {
    id: 'lander',
    nome: 'Lander',
    itens: [
      { n: 'Masteron',           p: 240, img: 'assets/img/produtos/lander-mfr-masteron.webp' },
      { n: 'Durateston',         p: 170, img: 'assets/img/produtos/lander-mfr-durateston.webp' },
      { n: 'Enantato',           p: 165, img: 'assets/img/produtos/lander-mfr-enantato.webp' },
      { n: 'Trembolona',         p: 170, img: 'assets/img/produtos/lander-mfr-trembolona.webp' },
      { n: 'Deca',               p: 165, img: 'assets/img/produtos/lander-mfr-deca.webp' },
      { n: 'Hemogenin',          p: 130, img: 'assets/img/produtos/lander-hemogenin.jpg' },
      { n: 'Oxandrolona',        p: 200, img: 'assets/img/produtos/lander-oxan.jpg' },
      { n: 'NPP',                p: 175, img: 'assets/img/produtos/lander-mfr-npp.webp' },
      { n: 'Sales de Trembo',    p: 215 },
      { n: 'Stano 15ml',         p: 135, img: 'assets/img/produtos/lander-mfr-stano15.webp' },
      { n: 'Stano 30ml',         p: 160, img: 'assets/img/produtos/lander-mfr-stano30.webp' },
      { n: 'Stano Comprimido',   p: 135, img: 'assets/img/produtos/lander-stano-caps.jpg' },
      { n: 'Testoland',          p: 160, img: 'assets/img/produtos/lander-mfr-testoland.webp' },
      { n: 'Propionato Testo',   p: 150, img: 'assets/img/produtos/lander-mfr-propionato.webp' },
      { n: 'Deca Branco',        p: 135 },
      { n: 'Androlic',           p: 150 },
      { n: 'Boldenona',          p: 175, img: 'assets/img/produtos/lander-boldenona.jpg' },
      { n: 'Clemburerol',        p: 135 },
      { n: 'Dianabol',           p: 140, img: 'assets/img/produtos/lander-mfr-dianabol.webp' },
      { n: 'GH',                 p: 1130 },
      { n: 'HCG',                p: 190, img: 'assets/img/produtos/lander-ghc.jpg' },
    ],
  },
  {
    id: 'perfumes',
    nome: 'Perfumes',
    itens: [
      { n: 'Paco Rabanne Invictus',                        d: 'EDT masculino 100 ml',            p: 310,      img: 'assets/img/produtos/perfume-paco-rabanne-invictus-edt-masculino-100-ml.webp' },
      { n: 'Calvin Klein Eternity',                        d: 'EDP feminino 100 ml',             p: 272,      img: 'assets/img/produtos/perfume-calvin-klein-eternity-edp-feminino-100-ml.webp' },
      { n: 'Calvin Klein Euphoria',                        d: 'EDP feminino 100 ml',             p: 248,      img: 'assets/img/produtos/perfume-calvin-klein-euphoria-edp-feminino-100-ml.webp' },
      { n: 'Issey Miyake L\'Eau d\'Issey',                 d: 'EDT masculino 125 ml',            p: 335,      img: 'assets/img/produtos/perfume-issey-miyake-l-eau-d-issey-edt-masculino-125-ml.webp' },
      { n: 'Christian Dior J\'adore',                      d: 'EDP feminino 100 ml',             p: 529,      img: 'assets/img/produtos/perfume-christian-dior-j-adore-edp-feminino-100-ml.webp' },
      { n: 'Jacques Bogart Silver Scent Intense',          d: 'EDT masculino 100 ml',            p: 149,      img: 'assets/img/produtos/perfume-jacques-bogart-silver-scent-intense-edt-masculino-10.webp' },
      { n: 'Animale For Men',                              d: 'EDT masculino 100 ml',            p: 165,      img: 'assets/img/produtos/perfume-animale-for-men-edt-masculino-100-ml.webp' },
      { n: 'Britney Spears Fantasy',                       d: 'EDP feminino 100 ml',             p: 176.5,    img: 'assets/img/produtos/perfume-britney-spears-fantasy-edp-feminino-100-ml.webp' },
      { n: 'Calvin Klein CK Be',                           d: 'EDT unissex 100 ml',              p: 159,      img: 'assets/img/produtos/perfume-calvin-klein-ck-be-edt-unissex-100-ml.webp' },
      { n: 'Paco Rabanne Lady Million',                    d: 'EDP feminino 80 ml',              p: 433,      img: 'assets/img/produtos/perfume-paco-rabanne-lady-million-edp-feminino-80-ml.webp' },
      { n: 'Hugo Boss Bottled',                            d: 'EDT masculino 100 ml',            p: 370,      img: 'assets/img/produtos/perfume-hugo-boss-bottled-edt-masculino-100-ml.webp' },
      { n: 'Paco Rabanne Phantom',                         d: 'EDT masculino 100 ml',            p: 379,      img: 'assets/img/produtos/perfume-paco-rabanne-phantom-edt-masculino-100-ml.webp' },
      { n: 'Animale',                                      d: 'EDP feminino 100 ml',             p: 189,      img: 'assets/img/produtos/perfume-animale-edp-feminino-100-ml.webp' },
      { n: 'Jacques Bogart Silver Scent',                  d: 'EDT masculino 100 ml',            p: 164,      img: 'assets/img/produtos/perfume-jacques-bogart-silver-scent-edt-masculino-100-ml.webp' },
      { n: 'Chloé',                                        d: 'EDP feminino 75 ml',              p: 449,      img: 'assets/img/produtos/perfume-chloe-edp-feminino-75-ml.webp' },
      { n: 'Montblanc Legend',                             d: 'EDT masculino 100 ml',            p: 285,      img: 'assets/img/produtos/perfume-montblanc-legend-edt-masculino-100-ml.webp' },
      { n: 'Paco Rabanne 1 Million',                       d: 'EDP masculino 100 ml',            p: 339,      img: 'assets/img/produtos/perfume-paco-rabanne-1-million-edp-masculino-100-ml.webp' },
      { n: 'Montblanc Starwalker',                         d: 'EDT masculino 75 ml',             p: 209,      img: 'assets/img/produtos/perfume-montblanc-starwalker-edt-masculino-75-ml.webp' },
      { n: 'Lancôme La Vie Est Belle',                     d: 'EDP feminino 100 ml',             p: 449,      img: 'assets/img/produtos/perfume-lancome-la-vie-est-belle-edp-feminino-100-ml.webp' },
      { n: 'Paco Rabanne Olympéa',                         d: 'EDP feminino 80 ml',              p: 464,      img: 'assets/img/produtos/perfume-paco-rabanne-olympea-edp-feminino-80-ml.webp' },
      { n: 'Marina de Bourbon Classique',                  d: 'EDP feminino 100 ml',             p: 209,      img: 'assets/img/produtos/perfume-marina-de-bourbon-classique-edp-feminino-100-ml.webp' },
      { n: 'Carolina Herrera 212 Men Heroes Forever Young',d: 'EDT masculino 90 ml',             p: 399,      img: 'assets/img/produtos/perfume-carolina-herrera-212-men-heroes-forever-young-edt-ma.webp' },
      { n: 'Giorgio Armani Acqua di Giò',                  d: 'EDT masculino 100 ml',            p: 409,      img: 'assets/img/produtos/perfume-giorgio-armani-acqua-di-gio-edt-masculino-100-ml.webp' },
      { n: 'Carolina Herrera 212',                         d: 'EDT feminino 100 ml',             p: 399,      img: 'assets/img/produtos/perfume-carolina-herrera-212-edt-feminino-100-ml.webp' },
      { n: 'Ted Lapidus Pour Homme',                       d: 'EDT masculino 100 ml',            p: 134,      img: 'assets/img/produtos/perfume-ted-lapidus-pour-homme-edt-masculino-100-ml.webp' },
      { n: 'Azzaro Chrome',                                d: 'EDT masculino 100 ml',            p: 275,      img: 'assets/img/produtos/perfume-azzaro-chrome-edt-masculino-100-ml.webp' },
      { n: 'Ferrari Scuderia Black',                       d: 'EDT masculino 125 ml',            p: 165,      img: 'assets/img/produtos/perfume-ferrari-scuderia-black-edt-masculino-125-ml.webp' },
      { n: 'Marina de Bourbon Royal Diamond',              d: 'EDP feminino 100 ml',             p: 215,      img: 'assets/img/produtos/perfume-marina-de-bourbon-royal-diamond-edp-feminino-100-ml.webp' },
      { n: 'Mercedes-Benz Club',                           d: 'EDT masculino 100 ml',            p: 260,      img: 'assets/img/produtos/perfume-mercedes-benz-club-edt-masculino-100-ml.webp' },
      { n: 'Elizabeth Arden Red Door',                     d: 'EDT feminino 100 ml',             p: 245,      img: 'assets/img/produtos/perfume-elizabeth-arden-red-door-edt-feminino-100-ml.webp' },
      { n: 'Antonio Banderas Blue Seduction',              d: 'EDT feminino 80 ml',              p: 145,      img: 'assets/img/produtos/perfume-antonio-banderas-blue-seduction-edt-feminino-80-ml.webp' },
      { n: 'Carolina Herrera CH Men',                      d: 'EDT masculino 100 ml',            p: 349,      img: 'assets/img/produtos/perfume-carolina-herrera-ch-men-edt-masculino-100-ml.webp' },
      { n: 'Mercedes-Benz For Men',                        d: 'EDT masculino 120 ml',            p: 230,      img: 'assets/img/produtos/perfume-mercedes-benz-for-men-edt-masculino-120-ml.webp' },
      { n: 'Carolina Herrera Bad Boy',                     d: 'EDT masculino 100 ml',            p: 395,      img: 'assets/img/produtos/perfume-carolina-herrera-bad-boy-edt-masculino-100-ml.webp' },
      { n: 'Montblanc Legend Red',                         d: 'EDP masculino 100 ml',            p: 265,      img: 'assets/img/produtos/perfume-montblanc-legend-red-edp-masculino-100-ml.webp' },
      { n: 'Paco Rabanne Fame',                            d: 'EDP feminino 80 ml',              p: 475,      img: 'assets/img/produtos/perfume-paco-rabanne-fame-edp-feminino-80-ml.webp' },
      { n: 'Montblanc Individuel',                         d: 'EDT masculino 75 ml',             p: 210,      img: 'assets/img/produtos/perfume-montblanc-individuel-edt-masculino-75-ml.webp' },
      { n: 'Calvin Klein CK One',                          d: 'EDT unissex 100 ml',              p: 170,      img: 'assets/img/produtos/perfume-calvin-klein-ck-one-edt-unissex-100-ml.webp' },
      { n: 'Ralph Lauren Polo Black',                      d: 'EDT masculino 125 ml',            p: 360,      img: 'assets/img/produtos/perfume-ralph-lauren-polo-black-edt-masculino-125-ml.webp' },
      { n: 'Antonio Banderas Seduction in Black',          d: 'EDT masculino 100 ml',            p: 140,      img: 'assets/img/produtos/perfume-antonio-banderas-seduction-in-black-edt-masculino-10.webp' },
      { n: 'Dolce & Gabbana Light Blue',                   d: 'EDT feminino 100 ml',             p: 375,      img: 'assets/img/produtos/perfume-dolce-gabbana-light-blue-edt-feminino-100-ml.webp' },
      { n: 'Azzaro Pour Homme',                            d: 'EDT masculino 100 ml',            p: 220,      img: 'assets/img/produtos/perfume-azzaro-pour-homme-edt-masculino-100-ml.webp' },
      { n: 'Animale Seduction Femme',                      d: 'EDP feminino 100 ml',             p: 210,      img: 'assets/img/produtos/perfume-animale-seduction-femme-edp-feminino-100-ml.webp' },
      { n: 'Christian Dior Sauvage',                       d: 'EDP masculino 100 ml',            p: 680,      img: 'assets/img/produtos/perfume-christian-dior-sauvage-edp-masculino-100-ml.webp' },
      { n: 'Calvin Klein Euphoria Men',                    d: 'EDT masculino 100 ml',            p: 230,      img: 'assets/img/produtos/perfume-calvin-klein-euphoria-men-edt-masculino-100-ml.webp' },
      { n: 'Carolina Herrera 212',                         d: 'EDT masculino 100 ml',            p: 370,      img: 'assets/img/produtos/perfume-carolina-herrera-212-edt-masculino-100-ml.webp' },
      { n: 'Carolina Herrera 212 Sexy',                    d: 'EDT masculino 100 ml',            p: 360,      img: 'assets/img/produtos/perfume-carolina-herrera-212-sexy-edt-masculino-100-ml.webp' },
      { n: 'Gilles Cantuel Arsenal Gold',                  d: 'EDP masculino 100 ml',            p: 140,      img: 'assets/img/produtos/perfume-gilles-cantuel-arsenal-gold-edp-masculino-100-ml.webp' },
      { n: 'Christian Dior Sauvage',                       d: 'EDT masculino 100 ml',            p: 475,      img: 'assets/img/produtos/perfume-christian-dior-sauvage-edt-masculino-100-ml.webp' },
      { n: 'Marina de Bourbon Passion Cristal Royal',      d: 'EDP feminino 100 ml',             p: 220, img: 'assets/img/produtos/perfume-marina-de-bourbon-passion-cristal-royal-edp-feminino.webp' },
      { n: 'Carolina Herrera 212 VIP',                     d: 'EDP feminino 80 ml',              p: 399,      img: 'assets/img/produtos/perfume-carolina-herrera-212-vip-edp-feminino-80-ml.webp' },
      { n: 'Victoria\'s Secret Rush',                      d: 'loção corporal 236 ml',           p: 95,       img: 'assets/img/produtos/perfume-victoria-s-secret-rush-locao-corporal-236-ml.webp' },
      { n: 'Victoria\'s Secret Temptation',                d: 'loção corporal 236 ml',           p: 95,       img: 'assets/img/produtos/perfume-victoria-s-secret-temptation-locao-corporal-236-ml.webp' },
      { n: 'Azzaro Chrome',                                d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-azzaro-chrome-edt-masculino-100-ml.webp' },
      { n: 'Ferrari Scuderia Black',                       d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-ferrari-scuderia-black-edt-masculino-125-ml.webp' },
      { n: 'Marina de Bourbon Royal Diamond',              d: 'miniatura EDP feminino 25 ml',    p: 90,       img: 'assets/img/produtos/perfume-marina-de-bourbon-royal-diamond-edp-feminino-100-ml.webp' },
      { n: 'Mercedes-Benz Club',                           d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-mercedes-benz-club-edt-masculino-100-ml.webp' },
      { n: 'Elizabeth Arden Red Door',                     d: 'miniatura EDT feminino 25 ml',    p: 90,       img: 'assets/img/produtos/perfume-elizabeth-arden-red-door-edt-feminino-100-ml.webp' },
      { n: 'Antonio Banderas Blue Seduction',              d: 'miniatura EDT feminino 25 ml',    p: 90,       img: 'assets/img/produtos/perfume-antonio-banderas-blue-seduction-edt-feminino-80-ml.webp' },
      { n: 'Carolina Herrera CH Men',                      d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-carolina-herrera-ch-men-edt-masculino-100-ml.webp' },
      { n: 'Mercedes-Benz For Men',                        d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-mercedes-benz-for-men-edt-masculino-120-ml.webp' },
      { n: 'Carolina Herrera Bad Boy',                     d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-carolina-herrera-bad-boy-edt-masculino-100-ml.webp' },
      { n: 'Montblanc Legend Red',                         d: 'miniatura EDP masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-montblanc-legend-red-edp-masculino-100-ml.webp' },
      { n: 'Paco Rabanne Fame',                            d: 'miniatura EDP feminino 25 ml',    p: 90,       img: 'assets/img/produtos/perfume-paco-rabanne-fame-edp-feminino-80-ml.webp' },
      { n: 'Montblanc Individuel',                         d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-montblanc-individuel-edt-masculino-75-ml.webp' },
      { n: 'Calvin Klein CK One',                          d: 'miniatura EDT unissex 25 ml',     p: 90,       img: 'assets/img/produtos/perfume-calvin-klein-ck-one-edt-unissex-100-ml.webp' },
      { n: 'Ralph Lauren Polo Black',                      d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-ralph-lauren-polo-black-edt-masculino-125-ml.webp' },
      { n: 'Antonio Banderas Seduction in Black',          d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-antonio-banderas-seduction-in-black-edt-masculino-10.webp' },
      { n: 'Dolce & Gabbana Light Blue',                   d: 'miniatura EDT feminino 25 ml',    p: 90,       img: 'assets/img/produtos/perfume-dolce-gabbana-light-blue-edt-feminino-100-ml.webp' },
      { n: 'Azzaro Pour Homme',                            d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-azzaro-pour-homme-edt-masculino-100-ml.webp' },
      { n: 'Animale Seduction Femme',                      d: 'miniatura EDP feminino 25 ml',    p: 90,       img: 'assets/img/produtos/perfume-animale-seduction-femme-edp-feminino-100-ml.webp' },
      { n: 'Christian Dior Sauvage',                       d: 'miniatura EDP masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-christian-dior-sauvage-edp-masculino-100-ml.webp' },
      { n: 'Calvin Klein Euphoria Men',                    d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-calvin-klein-euphoria-men-edt-masculino-100-ml.webp' },
      { n: 'Carolina Herrera 212',                         d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-carolina-herrera-212-edt-masculino-100-ml.webp' },
      { n: 'Carolina Herrera 212 Sexy',                    d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-carolina-herrera-212-sexy-edt-masculino-100-ml.webp' },
      { n: 'Gilles Cantuel Arsenal Gold',                  d: 'miniatura EDP masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-gilles-cantuel-arsenal-gold-edp-masculino-100-ml.webp' },
      { n: 'Christian Dior Sauvage',                       d: 'miniatura EDT masculino 25 ml',   p: 90,       img: 'assets/img/produtos/perfume-christian-dior-sauvage-edt-masculino-100-ml.webp' },
      { n: 'Marina de Bourbon Passion Cristal Royal',      d: 'miniatura EDP feminino 25 ml',    p: 90, img: 'assets/img/produtos/perfume-marina-de-bourbon-passion-cristal-royal-edp-feminino.webp' },
      { n: '212 Rose',                                     d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-212-rose-brand-collection-25-ml.webp'        },
      { n: '212 Gold',                                     d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-212-gold-brand-collection-25-ml.webp'        },
      { n: 'Olympéa',                                      d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-olympea-brand-collection-25-ml.webp'        },
      { n: 'La Vie Est Belle',                             d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-la-vie-est-belle-brand-collection-25-ml.webp'        },
      { n: 'Dior',                                         d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-dior-brand-collection-25-ml.webp'        },
      { n: 'Lady Million',                                 d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-lady-million-brand-collection-25-ml.webp'        },
      { n: 'Scandal',                                      d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-scandal-brand-collection-25-ml.webp'        },
      { n: 'Carolina Herrera',                             d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-carolina-herrera-brand-collection-25-ml.webp'        },
      { n: 'One Million',                                  d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-one-million-brand-collection-25-ml.webp'        },
      { n: 'Invictus',                                     d: 'Brand Collection 25 ml',          p: 90, img: 'assets/img/produtos/perfume-invictus-brand-collection-25-ml.webp'        },
      { n: 'Lattafa Yara',                                 d: 'EDP 100 ml',                      p: 299.99,   img: 'assets/img/produtos/perfume-lattafa-yara-edp-100-ml.webp' },
      { n: 'Lattafa Fakhar Gold',                          d: 'EDP 100 ml',                      p: 320,      img: 'assets/img/produtos/perfume-lattafa-fakhar-gold-edp-100-ml.webp' },
      { n: 'Lattafa Fakhar Rose',                          d: 'EDP 100 ml',                      p: 320,      img: 'assets/img/produtos/perfume-lattafa-fakhar-rose-edp-100-ml.webp' },
      { n: 'Lattafa Emeer',                                d: 'EDP 100 ml',                      p: 414.9,    img: 'assets/img/produtos/perfume-lattafa-emeer-edp-100-ml.webp' },
      { n: 'Lattafa Asad',                                 d: 'EDP 100 ml',                      p: 320,      img: 'assets/img/produtos/perfume-lattafa-asad-edp-100-ml.webp' },
      { n: 'Al Wataniah Duha',                             d: 'EDP 100 ml',                      p: 289,      img: 'assets/img/produtos/perfume-al-wataniah-duha-edp-100-ml.webp' },
      { n: 'Al Wataniah Amnia',                            d: 'EDP 100 ml',                      p: 419,      img: 'assets/img/produtos/perfume-al-wataniah-amnia-edp-100-ml.webp' },
      { n: 'Lattafa Musamam',                              d: 'EDP 100 ml',                      p: 469,      img: 'assets/img/produtos/perfume-lattafa-musamam-edp-100-ml.webp' },
      { n: 'Al Wataniah Sabah Al Ward',                    d: 'EDP 100 ml',                      p: 299,      img: 'assets/img/produtos/perfume-al-wataniah-sabah-al-ward-edp-100-ml.webp' },
    ],
  },
];
...
const SOBRE = {
  ...
  /* ---- Séruns ---- */
  'Glow Alluvi': 'Alluvi Labs GLOW Copper Peptide Face Serum, 30 mL. Cosmético de uso tópico com peptídeo de cobre (GHK-Cu) e colágeno. Aplicação com conta-gotas.',
  'GHK-CU': 'Sérum facial de uso tópico com peptídeo de cobre GHK-Cu, 30 mL, com conta-gotas. Cosmético.',
  'VL': 'Sérum facial de uso tópico com PDRN, 30 mL. Cosmético.',
  'Facial': 'Sérum facial de uso tópico com GHK-Cu e PDRN, 30 mL, com conta-gotas. Cosmético.',
  'Mousse': 'Sérum facial de textura mousse com PDRN e ácido hialurônico, 70 mL, com válvula pump. Cosmético.',

  /* ---- Dermocosméticos ---- */
  'Dr. Althea 147': 'Dr. Althea, cosmético coreano de uso tópico. Creme facial da linha 147.',
  'Dr. Althea 345': 'Dr. Althea, cosmético coreano de uso tópico. Creme facial da linha 345, com peptídeos.',
  'Celimax Vita': 'Celimax, cosmético coreano de uso tópico. Sérum facial com vitamina C.',
  'Numbuzin No.9': 'Numbuzin nº 9, cosmético coreano de uso tópico. Sérum facial da linha de peptídeos.',
  'Skin1004': 'SKIN1004, cosmético coreano de uso tópico, com extrato de centella asiática.',
  'Medicube Pink': 'Medicube, cosmético coreano de uso tópico. Linha Pink, para textura e poros.',
  'Medicube Zero': 'Medicube, cosmético coreano de uso tópico. Linha Zero Pore, para controle de oleosidade e poros.',
