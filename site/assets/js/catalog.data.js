...
const LINHAS = [
  {
    ...
    nome: 'Canetas',
    itens: [
      { n: 'Glow',          p: 655, fotos: ['assets/img/produtos/caneta-glow-alluvi.webp',
      ...
      { n: 'Retra Verde',   p: 655, img: 'assets/img/produtos/caneta-retra-verde.webp' },
      { n: 'NAD + B12',     p: 625, img: 'assets/img/produtos/caneta-nad-b12.webp' },
      ...
      { n: 'Klow 80mg',     d: 'caneta', p: 880, img: 'assets/img/produtos/caneta-klow80.webp' },
      { n: 'Retra 40mg',    d: 'sem agulha', p: 835, img: 'assets/img/produtos/caneta-retra-alluvi.webp' },
      { n: 'Retra 40mg',    d: 'com agulha', p: 835, img: 'assets/img/produtos/caneta-retra-alluvi.webp' },
      { n: 'Tirzegen',      d: 'sem agulha', p: 835, img: 'assets/img/produtos/oxygen-tirzegen-pen.webp' },
      // Foto: caneta NAD+ 1000mg+B12 da fonte oficial (único NAD+ Pen do catálogo Oxygen); item sem dose na tabela.
      { n: 'NAD+ Pen',      p: 860, img: 'assets/img/produtos/caneta-nadpen.webp' },
      ...
      { n: 'Mounjaro',      p: 1430, img: 'assets/img/produtos/mounjaro-kwikpen.webp' },
    ],
  },
  {
    id: 'renew',
    nome: 'Peptídeos',
    itens: [
      { n: 'GHK-CU 50mg',    p: 420, img: 'assets/img/produtos/px-ghk-cu-50.webp' },
      { n: 'GHK-CU 100mg',   p: 450, fotos: ['assets/img/produtos/neo-ghk-cu-100.webp',
                                             'assets/img/produtos/neo-ghk-cu-100-b.webp'] },
      { n: 'Ipamorelin 10mg',p: 460, img: 'assets/img/produtos/px-ipamorelin.webp' },
      { n: 'BPC-157 10mg',   p: 460, img: 'assets/img/produtos/renew-bpc157.webp' },
      { n: 'TB-500 10mg',    p: 460, img: 'assets/img/produtos/renew-tb500.webp' },
      { n: 'Glutathione',    p: 460 },
      { n: 'Frag 176 10mg',  p: 501, img: 'assets/img/produtos/neo-frag176.webp' },
      { n: 'Frag 176 15mg',  p: 500, img: 'assets/img/produtos/neo-frag176.webp' },
      { n: 'PT-141',         p: 485, img: 'assets/img/produtos/px-pt141.webp' },
      { n: 'Glow 70mg',      p: 480, img: 'assets/img/produtos/neo-glow-70.webp' },
      { n: 'Klow 80mg',      p: 485, img: 'assets/img/produtos/renew-klow-80.webp' },
      { n: 'MOTS 10mg',      p: 485, img: 'assets/img/produtos/renew-mots.webp' },
      { n: 'DSIP',           p: 485, img: 'assets/img/produtos/renew-dsip.webp' },
      { n: 'CJC + IPA',      p: 485, img: 'assets/img/produtos/neo-cjc-ipa.webp' },
      { n: 'Epithalon',      p: 485, img: 'assets/img/produtos/renew-epithalon.webp' },
      { n: 'SS31',           p: 485, img: 'assets/img/produtos/renew-ss31.webp' },
      { n: 'AOD9604',        p: 500, img: 'assets/img/produtos/px-aod9604.webp' },
      { n: 'BB10',           p: 485 },
      { n: 'Selank',         p: 485, img: 'assets/img/produtos/renew-selank.webp' },
      { n: 'Semax',          p: 485, img: 'assets/img/produtos/renew-semax.webp' },
      { n: 'NAD+ 100',       p: 430 },
      { n: 'NAD+ 500',       p: 480, img: 'assets/img/produtos/px-nad500.webp' },
      { n: 'SLUP332',        p: 500, img: 'assets/img/produtos/neo-slupp332.webp' },
      { n: 'Kisspeptin',     p: 500, img: 'assets/img/produtos/renew-kisspeptin.webp' },
      { n: 'KPV',            p: 485, img: 'assets/img/produtos/px-kpv.webp' },
      { n: 'Wolverine',      p: 485, img: 'assets/img/produtos/neo-wolverine.webp' },
      { n: 'CBL 20mg',       p: 500, img: 'assets/img/produtos/px-cbl20.webp' },
      { n: 'Tesamorelin',    p: 495, img: 'assets/img/produtos/neo-tesamorelin.webp' },
      { n: 'Retatrutide',    p: 500, img: 'assets/img/produtos/renew-retatrutide.webp' },
      { n: 'MOTS 40mg',      p: 530, img: 'assets/img/produtos/renew-mots.webp' },
      { n: 'CBL 60mg',       p: 560 },
      { n: 'Tirzec 30mg',     p: 460 },
      { n: 'Tirzec 60mg',     p: 500 },
      { n: 'Oxytocin 10mg',   p: 485 },
      { n: 'Pinealon 10mg',   p: 485 },
      { n: 'Tesa + Ipa 20mg', p: 530 },
      { n: 'Tesa 20mg',       p: 530 },
    ],
  },
  {
    ...
    itens: [
      { n: 'TG 15mg',                 p: 720, img: 'assets/img/produtos/tg-15mg.webp' },
      { n: 'Lipo Biotidina',          p: 430, img: 'assets/img/produtos/lipo-biotidina.webp' },
      { n: 'Lipoless MD',             p: 680, img: 'assets/img/produtos/lipoless-md.webp' },
      { n: 'Lipoless',                d: '4 ampolas', p: 685, img: 'assets/img/produtos/lipoless-md.webp' },
      { n: 'Lipoless Orgoglip 0.8',   p: 455, img: 'assets/img/produtos/lipoless-orgoglip.webp' },
      { n: 'Lipoless Orgoglip 2.5',   p: 480, img: 'assets/img/produtos/lipoless-orgoglip.webp' },
      { n: 'Lipoless Orgoglip 5.5',   p: 500, img: 'assets/img/produtos/lipoless-orgoglip.webp' },
      { n: 'Lipoland MD',             p: 630, img: 'assets/img/produtos/lipoland-md.webp' },
      { n: 'Lipoland',                d: '4 ampolas', p: 680, img: 'assets/img/produtos/lipoland.webp' },
      { n: 'Tirzec',                  d: '1 ampola',  p: 675, img: 'assets/img/produtos/tirzec-md.webp' },
      { n: 'Tirzec',                  d: '4 ampolas', p: 680, img: 'assets/img/produtos/tirzec.webp' },
      { n: 'Tirzedal',                d: '4 ampolas', p: 680, img: 'assets/img/produtos/tirzedal.webp' },
      { n: 'Tirzedral T36',           p: 730, img: 'assets/img/produtos/tirzedral-t36.webp' },
      { n: 'Tirzedral T36',           d: '4 ampolas', p: 730, img: 'assets/img/produtos/tirzedral-t36.webp' },
      { n: 'Gluconex',                p: 700, img: 'assets/img/produtos/gluconex.webp' },
      { n: 'Slimex MD',               p: 680, img: 'assets/img/produtos/slimex-md.webp' },
      { n: 'Slimex',                  d: '4 ampolas', p: 695, img: 'assets/img/produtos/slimex.webp' },
  ...
  },
  {
    ...
    itens: [
      { n: 'Line Body',                       p: 940, img: 'assets/img/produtos/line-body.webp' },
      { n: 'Botox Dysport',                   p: 465, img: 'assets/img/produtos/dysport.webp' },
      ...
      { n: 'Retra Synedica Pó 120mg',         p: 855, img: 'assets/img/produtos/retra-synedica-120.webp' },
      { n: 'Tirzepatide Synedica Pó 240mg',   p: 800, img: 'assets/img/produtos/tirzepatide-synedica-240.webp' },
  ...
  },
  {
    ...
    nome: 'Oxygen',
    itens: [
      { n: 'AHK-CU',         p: 550,  img: 'assets/img/produtos/oxygen-ahk-cu.webp' },
      { n: 'GHK-CU 50mg',    p: 495,  img: 'assets/img/produtos/oxygen-ghk-cu-50.webp' },
      { n: 'GHK-CU 100mg',   p: 550,  img: 'assets/img/produtos/oxygen-ghk-cu-100.webp' },
      { n: 'Cagrisema',      p: 650, img: 'assets/img/produtos/oxygen-cagrisema.webp' },
      ...
      { n: 'Retagen 80mg',   p: 785,  img: 'assets/img/produtos/oxygen-retagen-80.webp' },
      { n: 'Retagen 120mg',  d: 'diluído', p: 905, img: 'assets/img/produtos/oxygen-retagen-120.webp' },
      { n: 'Retagen 120mg',  d: 'liofilizada', p: 905, img: 'assets/img/produtos/oxygen-retagen-120.webp' },
      { n: 'Retagen 160mg',  p: 900, img: 'assets/img/produtos/oxygen-retagen-160.webp' },
      { n: 'Retagen 40mg',   d: 'diluída', p: 755, img: 'assets/img/produtos/oxygen-retagen40-diluida.webp' },
      { n: 'Retagen 40mg',   d: 'liofilizado', p: 730, img: 'assets/img/produtos/oxygen-retagen40-lio.webp' },
      { n: 'Retagen 60mg',   d: 'liofilizada', p: 780, img: 'assets/img/produtos/oxygen-retagen60.webp' },
      { n: 'Selank',         d: 'nasal', p: 560 },
      { n: 'Semax',          d: 'nasal', p: 560 },
      ...
      { n: 'Glow Pen',       p: 760,  img: 'assets/img/produtos/oxygen-glow-pen.webp' },
      { n: 'GHK-CU Pen',     p: 760,  img: 'assets/img/produtos/oxygen-ghk-cu-pen.webp' },
      { n: 'Klow Pen',       p: 780,  img: 'assets/img/produtos/oxygen-klow-pen.webp' },
    ],
  },
  {
    id: 'esteticos',
    ...
    itens: [
      { n: 'Veltrane 90mg',   p: 700, img: 'assets/img/produtos/veltrane-90.webp' },
      { n: 'Veltrane 120mg',  p: 740, img: 'assets/img/produtos/veltrane-120.webp' },
  ...
  },
  {
    ...
    nome: 'Séruns',
    itens: [
      { n: 'Glow Alluvi',  p: 465, img: 'assets/img/produtos/serum-glow-alluvi.webp' },
      { n: 'GHK-CU',       p: 410, img: 'assets/img/produtos/serum-ghk-cu.webp' },
  ...
  },
  {
    ...
    itens: [
      { n: 'Dr. Althea 147',  p: 435, img: 'assets/img/produtos/dr-althea-147.webp' },
      { n: 'Dr. Althea 345',  p: 435, img: 'assets/img/produtos/dr-althea-345.webp' },
      { n: 'Celimax Vita',    p: 380, img: 'assets/img/produtos/celimax-vita.webp' },
      { n: 'Numbuzin No.9',   p: 430, img: 'assets/img/produtos/numbuzin-no9.webp' },
      { n: 'Skin1004',        p: 407, img: 'assets/img/produtos/skin1004.webp' },
      { n: 'Medicube Pink',   p: 418, img: 'assets/img/produtos/medicube-pink.webp' },
      { n: 'Medicube Zero',   p: 410, img: 'assets/img/produtos/medicube-zero.webp' },
      { n: 'Quenavin',             d: '30 cápsulas', p: 380, img: 'assets/img/produtos/quenavin-capsulas.jpg' },
      { n: 'Quenavin Shampoo',       p: 375, img: 'assets/img/produtos/quenavin-shampoo.jpg' },
      { n: 'Quenavin Condicionador', p: 375, img: 'assets/img/produtos/quenavin-condicionador.jpg' },
    ],
  },
  {
    id: 'dragon',
    ...
    itens: [
      { n: 'GHK-CU',      p: 480, img: 'assets/img/produtos/dragon-ghk-cu.webp' },
      { n: 'SLU-PP-332',  p: 480, img: 'assets/img/produtos/dragon-slu-pp-332.webp' },
      { n: 'Organ Shield',p: 465, img: 'assets/img/produtos/dragon-organ-shield.webp' },
      { n: 'MK-677',      p: 465, img: 'assets/img/produtos/dragon-mk-677.webp' },
      { n: 'Cardarine',   p: 506, img: 'assets/img/produtos/dragon-cardarine.webp' },
      { n: 'Ligandrol',   p: 465, img: 'assets/img/produtos/dragon-ligandrol.webp' },
    ],
  },
  {
    id: 'lander',
    nome: 'Lander',
    itens: [
      { n: 'Masteron',           p: 440, img: 'assets/img/produtos/lander-mfr-masteron.webp' },
      { n: 'Durateston',         p: 370, img: 'assets/img/produtos/lander-mfr-durateston.webp' },
      { n: 'Enantato',           p: 365, img: 'assets/img/produtos/lander-mfr-enantato.webp' },
      { n: 'Trembolona',         p: 370, img: 'assets/img/produtos/lander-mfr-trembolona.webp' },
      { n: 'Deca',               p: 365, img: 'assets/img/produtos/lander-mfr-deca.webp' },
      { n: 'Hemogenin',          p: 330, img: 'assets/img/produtos/lander-hemogenin.jpg' },
      { n: 'Oxandrolona',        p: 400, img: 'assets/img/produtos/lander-oxan.jpg' },
      { n: 'NPP',                p: 375, img: 'assets/img/produtos/lander-mfr-npp.webp' },
      { n: 'Sales de Trembo',    p: 415 },
      { n: 'Stano 15ml',         p: 335, img: 'assets/img/produtos/lander-mfr-stano15.webp' },
      { n: 'Stano 30ml',         p: 360, img: 'assets/img/produtos/lander-mfr-stano30.webp' },
      { n: 'Stano Comprimido',   p: 335, img: 'assets/img/produtos/lander-stano-caps.jpg' },
      { n: 'Testoland',          p: 360, img: 'assets/img/produtos/lander-mfr-testoland.webp' },
      { n: 'Propionato Testo',   p: 350, img: 'assets/img/produtos/lander-mfr-propionato.webp' },
      { n: 'Deca Branco',        p: 335 },
      { n: 'Androlic',           p: 350 },
      { n: 'Boldenona',          p: 375, img: 'assets/img/produtos/lander-boldenona.jpg' },
      { n: 'Clemburerol',        p: 335 },
      { n: 'Dianabol',           p: 340, img: 'assets/img/produtos/lander-mfr-dianabol.webp' },
      { n: 'GH',                 p: 1330 },
      { n: 'HCG',                p: 390, img: 'assets/img/produtos/lander-ghc.jpg' },
    ],
  },
  {
    id: 'perfumes',
